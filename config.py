...
class Config:
    def __init__(self) -> None:
        self.root_path: str = "second-best"

        # for data loader
        self.data_set: str = "nerelbio"
        ...
        # for bert
        self.bert_model: str = 'DeepPavlov/rubert-base-cased'
        ...
        self.data_path: str = self.root_path + "/../data/{}/{}".format(self.data_set, self.data_set)
